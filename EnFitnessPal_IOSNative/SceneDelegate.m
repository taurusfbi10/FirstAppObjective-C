...
- (void)scene:(UIScene *)scene willConnectToSession:(UISceneSession *)session options:(UISceneConnectionOptions *)connectionOptions {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(switchToLoginScreen:) name:@"switchToLogin" object:nil];
    ...
    if (isLoggedIn) {
        ...
        [_window makeKeyAndVisible];
        [navController setNavigationBarHidden:YES animated:NO];
        [navController setViewControllers:@[loginViewController] animated:YES];
    }
